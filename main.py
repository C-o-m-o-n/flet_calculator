...
def update_txt_field(data):
    ...
    txt_field.value = handle_parentheses(data, txt_field.value)
...
def handle_parentheses(data, txt_field):
    """Handles parentheses input validation and correction."""
    if data == ")":
        if txt_field and txt_field.count("(") > txt_field.count(")"):
            return txt_field + data
        else:
            return txt_field + "("
    else:
        return txt_field + data
